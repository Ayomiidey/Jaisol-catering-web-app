...
import { ApiCarouselSlide, useCarouselSlides } from "@/hooks/use-carousels";
...
const fallbackSlides = [
  {
    ...
    title: "Authentic West African flavours",
    subtitle: "Freshly prepared favourites, delivered to your door.",
    link: "/explore",
  },
  {
    image: "/images/fullhouse-box.png",
    title: "Catering made memorable",
    subtitle: "Food for celebrations, events, and every special gathering.",
    link: "/book",
  },
  {
